...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['assetic.filter.yui_css'] = $instance = new \Assetic\Filter\Yui\CssCompressorFilter(($this->targetDirs[2].'/Resources/java/yuicompressor-2.4.8.jar'), 'C: rogram Files (x86)\\Java\\jre1.8.0_51in');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'crotoy', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\VF\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\VF\\CrotoyBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\VF\\BookingBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\VF\\BlogBundle\\Entity')));
        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'VF\\UserBundle\\Entity');
        $c->addDriver($b, 'VF\\CrotoyBundle\\Entity');
        $c->addDriver($b, 'VF\\BookingBundle\\Entity');
        $c->addDriver($b, 'VF\\BlogBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('VFUserBundle' => 'VF\\UserBundle\\Entity', 'VFCrotoyBundle' => 'VF\\CrotoyBundle\\Entity', 'VFBookingBundle' => 'VF\\BookingBundle\\Entity', 'VFBlogBundle' => 'VF\\BlogBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_0f0829c130baf0153cd2f20946e430b2d746b34cebdcfe4819420be1f308c11a');
        return $instance;
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('VF\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('VF\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('VF\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('VF\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'VF\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('VF\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $l = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '2e7cfceaacee0cbf4e76e7d49165b6a40b494473', 'main', array('lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'name' => 'REMEMBERME', 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
        ...
        $p = new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $g, $h, $k, 'main', $n, $o, array('check_path' => 'fos_user_security_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $d, NULL);
        $p->setRememberMeServices($l);
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($j, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c), 'main', $a, $d), 2 => $m, 3 => $p, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $l, $g, $a, $d, true, $h), 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5676ba6a118920.84293989', $a, $g), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $j, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $k, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $k, 'fos_user_security_login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('vincent.froidevaux');
        $a->setPassword('gknrv_lampion');
        $a->setAuthMode(NULL);
        $this->services['swiftmailer.mailer.default.transport.real'] = $instance = new \Swift_Transport_EsmtpTransport(new \Swift_Transport_StreamBuffer(new \Swift_StreamFilters_StringReplacementFilterFactory()), array(0 => $a), $this->get('swiftmailer.mailer.default.transport.eventdispatcher'));
        $instance->setHost('mail.bluewin.ch');
        $instance->setPort(25);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\VF\\CoreBundle/Resources/views'), 'VFCore');
        $instance->addPath(($this->targetDirs[3].'\\src\\VF\\UserBundle/Resources/views'), 'VFUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\VF\\CrotoyBundle/Resources/views'), 'VFCrotoy');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\VF\\BookingBundle/Resources/views'), 'VFBooking');
        $instance->addPath(($this->targetDirs[3].'\\src\\VF\\BlogBundle/Resources/views'), 'VFBlog');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('2e7cfceaacee0cbf4e76e7d49165b6a40b494473');
    }
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_INVITE' => array(0 => 'ROLE_USER'), 'ROLE_RESERVANT' => array(0 => 'ROLE_INVITE'), 'ROLE_PROPRIETAIRE' => array(0 => 'ROLE_RESERVANT'), 'ROLE_ADMIN' => array(0 => 'ROLE_PROPRIETAIRE'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'VFCoreBundle' => 'VF\\CoreBundle\\VFCoreBundle',
                'VFUserBundle' => 'VF\\UserBundle\\VFUserBundle',
                'VFCrotoyBundle' => 'VF\\CrotoyBundle\\VFCrotoyBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'VFBookingBundle' => 'VF\\BookingBundle\\VFBookingBundle',
                'VFBlogBundle' => 'VF\\BlogBundle\\VFBlogBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'crotoy',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => 'mail.bluewin.ch',
            'mailer_user' => 'vincent.froidevaux',
            'mailer_password' => 'gknrv_lampion',
            'secret' => '2e7cfceaacee0cbf4e76e7d49165b6a40b494473',
            'locale' => 'fr',
            ...
            'kernel.secret' => '2e7cfceaacee0cbf4e76e7d49165b6a40b494473',
            ...
            'security.role_hierarchy.roles' => array(
                ...
                'ROLE_RESERVANT' => array(
                    0 => 'ROLE_INVITE',
                ),
                'ROLE_PROPRIETAIRE' => array(
                    0 => 'ROLE_RESERVANT',
                ),
                'ROLE_ADMIN' => array(
                    0 => 'ROLE_PROPRIETAIRE',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'mail.bluewin.ch',
            'swiftmailer.mailer.default.transport.smtp.username' => 'vincent.froidevaux',
            'swiftmailer.mailer.default.transport.smtp.password' => 'gknrv_lampion',
            ...
            'assetic.java.bin' => 'C: rogram Files (x86)\\Java\\jre1.8.0_51in',
            ...
            'assetic.filter.yui_css.java' => 'C: rogram Files (x86)\\Java\\jre1.8.0_51in',
            ...
            'fos_user.model.user.class' => 'VF\\UserBundle\\Entity\\User',
