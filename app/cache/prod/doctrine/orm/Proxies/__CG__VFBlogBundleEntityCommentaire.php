 ...
 */
class Commentaire extends \VF\BlogBundle\Entity\Commentaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'VF\\BlogBundle\\Entity\\Commentaire' . "\0" . 'id', '' . "\0" . 'VF\\BlogBundle\\Entity\\Commentaire' . "\0" . 'titre', '' . "\0" . 'VF\\BlogBundle\\Entity\\Commentaire' . "\0" . 'date', '' . "\0" . 'VF\\BlogBundle\\Entity\\Commentaire' . "\0" . 'auteur', '' . "\0" . 'VF\\BlogBundle\\Entity\\Commentaire' . "\0" . 'texte', '' . "\0" . 'VF\\BlogBundle\\Entity\\Commentaire' . "\0" . 'article'];
        }
