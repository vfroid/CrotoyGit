...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/css/63dff8e')) {
            // _assetic_63dff8e
            if ($pathinfo === '/css/63dff8e.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '63dff8e',  'pos' => NULL,  '_format' => 'css',  '_route' => '_assetic_63dff8e',);
            }

            // _assetic_63dff8e_0
            if ($pathinfo === '/css/63dff8e_blog_1.css') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '63dff8e',  'pos' => 0,  '_format' => 'css',  '_route' => '_assetic_63dff8e_0',);
            }
